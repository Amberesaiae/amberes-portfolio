      ...
      {isOpen && (
        <>
          ...
          <div className="fixed inset-0 z-[101] overflow-y-auto">
            <div className="min-h-full flex items-center justify-center p-4 sm:p-4 md:p-6 py-8 sm:py-4">
              <motion.div
                ref={modalRef}
                ...
                className="relative w-full max-w-3xl md:max-w-4xl bg-[#0a0a0a] border border-white/10 shadow-2xl max-h-[80vh] sm:max-h-[85vh] overflow-hidden rounded-sm"
