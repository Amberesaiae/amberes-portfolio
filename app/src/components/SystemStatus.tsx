...
export default function SystemStatus() {
  return (
    <section className="min-h-screen flex items-center justify-center py-24 px-6 md:px-10 bg-[#0a0a0a] border-t border-white/5 relative overflow-hidden">
      {/* Background patterns */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          >
            <TiltCard intensity={15} className="w-full">
              <div className="relative h-[650px] lg:h-[750px] border border-white/10 bg-[#050505] flex flex-col shadow-2xl overflow-hidden rounded-sm">
                {/* Terminal Titlebar */}
                <div className="flex items-center justify-between px-4 py-4 md:px-8 md:py-5 border-b border-white/10 bg-white/5 backdrop-blur-md">
                  <div className="flex items-center gap-4">
                    <h3 className="text-[10px] font-black text-white/80 tracking-[0.4em] uppercase font-mono">Kernel_Core.sh</h3>
                    <div className="w-1.5 h-1.5 rounded-full bg-[#FFB000] shadow-[0_0_12px_rgba(255,176,0,0.6)] animate-pulse" />
                  </div>
          ...
          <div className="lg:col-span-5 space-y-12">
            ...
            {/* Metadata Grid */}
            <div className="grid grid-cols-2 gap-y-10 gap-x-12 pt-12 border-t border-white/5">
              {[
