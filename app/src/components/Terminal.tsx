...
const NEOFETCH_OUTPUT = (
  <div className="flex flex-col xl:flex-row gap-6 mb-4">
    ...
    {/* Mobile ASCII art - compact version of same logo */}
    <pre className="md:hidden text-[#FFB000] font-mono text-[7px] leading-[1.2] font-bold">{NEOFETCH_ASCII_MOBILE}</pre>
