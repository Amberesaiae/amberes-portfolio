...
export const projects: ProjectData[] = [
  {
    ...
    image: '/images/project-needbe-1.webp',
    gallery: ['/images/project-needbe-1.webp', '/images/project-needbe-2.webp', '/images/project-needbe-3.webp'],
  ...
  },
  {
    ...
    image: '/images/software/containerclear.webp',
    cardIcon: '/images/software/containerclear.webp',
    status: 'shipped',
    featured: false,
    imageFit: 'contain',
    spec: {
  ...
  },
  {
    ...
    image: '/images/software/glean.webp',
    cardIcon: '/images/software/glean.webp',
    status: 'in-progress',
    featured: false,
    imageFit: 'contain',
    spec: {
  ...
  },
  {
    ...
    cardIcon: '/images/software/jingo.webp',
    status: 'in-progress',
    featured: false,
    imageFit: 'contain',
    spec: {
  ...
  },
  {
    ...
    image: '/images/software/noragami.webp',
    cardIcon: '/images/software/noragami.webp',
    status: 'in-progress',
    featured: false,
    imageFit: 'contain',
    spec: {
